  ...
  const allFrases = [
    {
      ...
      frases: [
        ...
        "A maior barreira para o successo é o medo do fracasso"
      ]
    },
    {
      id: 2,
      nome: "Bom dia",
      frases: [
        "Acordar de bem com a vida é o primeiro passo para ter um dia abeçoado! Bom dia, família!",
        ...
        "Bom dia! Não se esqueca que a sua alma é o reflexo do sol, tão forte e brilhante quanto um girassol.",
      ]
    }
  ]

  function handleSwtichCategory(index: number){
    ...
    <div className='container'>
      ...
      <section className='category-area'>
        {allFrases.map((item, index) => (
          ...
          onClick={() => {handleSwtichCategory(index)}}
          >
            {item.nome} 
          </button>
        ))}
